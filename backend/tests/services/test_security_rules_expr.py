...
class TestRulesReferencingJa4:
    def test_finds_ja4_rules(self, db):
        ...
        from app.services.security_rules import parse_expression, rules_referencing_ja4

        r1 = SecurityRule(
            name="ja4-eq",
            expression='http.request.ja4 = "t13d1516h2_8daaf6152771_b186095e22b6"',
            action="block",
            priority=0,
            listener_ids=[],
        ...
        r3 = SecurityRule(
            name="ja4-in-list",
            expression="http.request.ja4 in $ja4:badbots",
            action="block",
            priority=2,
            listener_ids=[],
    ...
    def test_falls_back_to_text_scan(self, db):
        ...
        r = SecurityRule(
            name="no-ast",
            expression='http.request.ja4 = "t13d..."',
            action="block",
            priority=0,
            listener_ids=[],
            expression_ast=None,
